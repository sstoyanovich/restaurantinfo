...
$query2 = "SELECT * FROM pages_viewed_bots WHERE location=''";
...
while ($rs2 = mysql_fetch_object($result2))
{
	...
	if ($ip_address)
	{
		...
		$query3 = "UPDATE pages_viewed_bots SET location='" . mysql_real_escape_string($tags["geobytesfqcn"]) . "' WHERE id=" . $rs2->id;
		echo $query3 . "<br>";

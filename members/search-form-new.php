...
<form class="search" action="search.php" method="get" name="search">
...
<? endif ?>
    ...
    <div class="search-simple">
        <dl class="search-what">
            <dt>
                <input name="search_terms" id="search_terms" type="text" value="<?=$search_terms?>" placeholder="Job title, Keyword">
            </dt>
            <dd>What</dd>
        </dl>
        <dl class="search-where">
            <dt>
                <input name="search_location" id="search_location" type="text" value="<?=$search_location?>" placeholder="City, State">
            </dt>
            <dd>Where</dd>
        </dl>
    </div><!--/ .search-simple-->
...
<? /*
    ...
    <tr>
      <td>Job Category</td>
      <td><select name="category" id="category" style="width:220px;">
...
*/ ?>
    ...
    <table id="old-search" style="display: none;">
        <tr>
            <td><sup>*</sup>Job Title&nbsp; </td>
            <td>
                <select name="job_title_id" id="job_title_id"  style="width:200px;">
                    <option  value="0">Select</option>
                    <?
                        $query2 = "SELECT DISTINCT job_titles.job_title_id, job_titles.job_title FROM job_titles INNER JOIN jobs ON job_titles.job_title_id = jobs.job_title_id AND jobs.expired=0 ORDER BY  `job_titles`.`job_title_id`";
                        $result2 = mysql_query($query2) or die(mysql_error());
        ...
        <tr>
            <td> <sup>*</sup>Job Title&nbsp; </td>
            <td><input type="text" name="job_title" size="40" maxlength="255" style="width:200px" value="<?=$job_title?>"  onfocus="this.select();"></td>
        </tr>
        <tr>
            <td></td>
            <td><sup>*</sup><em style="color:#999">Select and/or enter the job title above.</em></td>
        </tr>
    </table>
